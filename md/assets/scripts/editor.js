  ...
  data: function () {
    return {
      ...
      builtinFonts: [
        ...
        { label: '无衬线', value: "PingFangSC, SFUIDisplay, sans-serif, Roboto, Oxygen, Ubuntu, Cantarell, PingFangSC-light, PingFangTC-light, 'Open Sans', 'Helvetica Neue'"}
      ],
      currentFont: "PingFangSC, SFUIDisplay, sans-serif, Roboto, Oxygen, Ubuntu, Cantarell, PingFangSC-light, PingFangTC-light, 'Open Sans', 'Helvetica Neue'",
      currentSize: '16px',
      sizeOption: [
